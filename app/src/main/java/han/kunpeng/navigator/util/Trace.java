package han.kunpeng.navigator.util;
...
/**
 * Logging for Wage Slaves
 * Inspired by https://github.com/JakeWharton/timber
 */
...
public final class Trace {
    ...
    public static class DebugTree extends Tree {
        ...
        protected String createStackElementTag(@NotNull StackTraceElement element) {
            ...
            return tag.substring(0, MAX_TAG_LENGTH) + "(Line " + element.getLineNumber() + ")";
        }
